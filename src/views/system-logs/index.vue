<template>
  <div class="system-logs-page" :class="{ 'theme-dark': navTheme === 'dark' }">
    ...
    <div class="filter-bar">
      <a-select v-model="filterLevel" style="width: 140px" allow-clear placeholder="级别">
        <a-select-option value="INFO">INFO</a-select-option>
        <a-select-option value="WARN">WARN</a-select-option>
        <a-select-option value="ERROR">ERROR</a-select-option>
      </a-select>
      <a-input v-model="filterModule" placeholder="模块（如 http）" style="width: 180px" allow-clear />
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { title: '时间', dataIndex: 'time', width: 170, scopedSlots: { customRender: 'time' } },
        ...
        { title: '路由', dataIndex: 'route', width: 220 },
